...
import com.lelaohui.ipcarmearlibrary.adapter.SearchListAdapter;
...
*/
	...
	public void onClick(View v) {
		...
		} else if (i == R.id.location_pics_videos) {
		...
		} else if (i == R.id.btn_searchCamera) {
			stopCameraPPPP();
			//把相机状态，设备id置空
			tag = 0;
