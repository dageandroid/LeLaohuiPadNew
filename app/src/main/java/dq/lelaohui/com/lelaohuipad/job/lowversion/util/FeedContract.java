...
public class FeedContract {
     ...
     */
    public static final String CONTENT_AUTHORITY = "dq.lelaohui.com.lelaohuipad";
    ...
    public static class Entry implements BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.dqbasicsyncadapter.entries";
        /**
         * MIME type for individual entries.
         */
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.dqbasicsyncadapter.entry";
         ...
         */
        public static final String TABLE_NAME = ProCateServiceDao.TABLENAME;
        /**
